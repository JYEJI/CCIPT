...
public class TeamMemberListViewAdapter extends BaseAdapter {
    private ArrayList<TeamMemberListViewItem> listViewItems = new ArrayList<TeamMemberListViewItem>();

    public TeamMemberListViewAdapter(){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TeamMemberListViewItem listViewItem = listViewItems.get(position);
    ...
    public void addItem(Bitmap icon, String title) {
        TeamMemberListViewItem item = new TeamMemberListViewItem();
